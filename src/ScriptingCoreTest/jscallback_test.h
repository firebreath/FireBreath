...
TEST(JSCallback_Basics)
{
    ...
    {
        FB::JSAPIPtr test = FB::make_callback(backing.ptr(), &TestObjectJSAPIAuto::returnString);
    ...
    {
        FB::JSAPIPtr test = FB::make_callback(backing.ptr(), &TestObjectJSAPIAuto::concatenate);
    ...
    
    {
        ...
        FB::JSAPIPtr test = FB::make_callback(backing.ptr(), &TestObjectJSAPIAuto::concatMany);
