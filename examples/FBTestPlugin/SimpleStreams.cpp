...
bool StreamsTest::run()
{
	...
	FB::BrowserStream* testStream1 = host->createStream( "http://www.batemansr.us/sammi.jpg", streamHandler1, true, false );

	// create a seekable, non-cached stream
	FB::PluginEventSink* streamHandler2 = new MyStreamHandler2;
	FB::BrowserStream* testStream2 = host->createStream( "http://www.batemansr.us/images/Family.jpg", streamHandler2, false, true );
