...
namespace FB {
    ...
    public:
        ...
        ///
        /// @brief  Call to get the stream associated with this handler. Returns 0 if none.
        ///
        /// @author Matthias
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::BrowserStream* getStream() const;
    ...
    protected:
        ...
        /// @author Matthias
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual void setStream(FB::BrowserStream* stream);
