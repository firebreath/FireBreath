...
namespace FB { namespace DOM {
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<std::string> getInnerHTML() const;
        ...
        /// @return The width.
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<int> getWidth() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<int> getScrollWidth() const;
        ...
        /// @return The height.
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<int> getHeight() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<int> getScrollHeight() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<int> getChildNodeCount() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<ElementPtr> getChildNode(const int idx) const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<ElementPtr> getParentNode() const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<ElementPtr> getElement(std::string name) const
        {
        ...
        /// @return The child element.
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<ElementPtr> getElement(const int idx) const
        {
            auto onDone = [](FB::JSObjectPtr api) -> ElementPtr {
                ElementPtr retVal((api) ? new Element(api) : nullptr);
                return retVal;
        ...
        virtual FB::Promise<std::string> getStringAttribute(std::string attr) const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<ElementPtr> getElementById(std::string elem_id) const;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<std::vector<ElementPtr>> getElementsByTagName(std::string tagName) const;

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// @overload virtual std::vector<ElementPtr> getElementsByTagName(const std::wstring& tagName) const
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        virtual FB::Promise<std::vector<ElementPtr>> getElementsByTagName(const std::wstring& tagName) const;
    };
